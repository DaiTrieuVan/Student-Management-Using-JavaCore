...
import repository.StudentManagerFindRepository;

import java.util.List;
import java.util.stream.Collectors;

public class StudentService implements IStudentService {
    private final IStudentRepository studentRepository = new StudentManagerFindRepository();
    ...
    public void add(Student student) {
        ...
        studentRepository.saveAllStudent(students);
    }
    ...
    public void update(Student student) {
        ...
        } else studentRepository.saveAllStudent(students);
    }
